...
(ns ewen.transit.test.core
  (:require [ewen.transit :as t]
...
(deftest test-basic-write
  (testing "Testing basic Transit write"
    ...
    #_(is (= (t/write w #{1 2 3}) "{\"~#set\":[1,2,3]}"))
...
(deftest test-roundtrip
  (testing "Testing round tripping"
    ...
    #_(is (= (roundtrip "[\"^ \",\"~:key0000\",0,\"~:key0001\",1,\"~:key0002\",2,\"~:key0003\",3,\"~:key0004\",4,\"~:key0005\",5,\"~:key0006\",6,\"~:key0007\",7,\"~:key0008\",8,\"~:key0009\",9]")
