...
goog.provide("ewen.transit.impl.writer");
goog.require("ewen.transit.util");
goog.require("ewen.transit.caching");
goog.require("ewen.transit.handlers");
goog.require("ewen.transit.types");
goog.require("ewen.transit.delimiters");
goog.require("goog.math.Long");
goog.require("ewen.transit.impl.writer_object_builder");
goog.require("ewen.transit.impl.writer_unpack");

goog.scope(function () {

    var writer   = ewen.transit.impl.writer,
        util     = ewen.transit.util,
        caching  = ewen.transit.caching,
        handlers = ewen.transit.handlers,
    ...
    writer.JSONMarshaller = function Transit$JSONMarshaller(opts) {
        ...
        this.objectBuilder = this.opts["objectBuilder"] || ewen.transit.impl.writer_object_builder.object_builder;
        ...
        this.unpack = this.opts["unpack"] || ewen.transit.impl.writer_unpack.unpack;
