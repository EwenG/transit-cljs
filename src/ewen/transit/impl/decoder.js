...
goog.provide("ewen.transit.impl.decoder");
goog.require("ewen.transit.util");
goog.require("ewen.transit.delimiters");
goog.require("ewen.transit.caching");
goog.require("ewen.transit.types");
goog.require("ewen.transit.impl.decoder_builders");
goog.require("ewen.transit.impl.cljs_handlers")
goog.require("cljs.core");

goog.scope(function () {

    var decoder = ewen.transit.impl.decoder,
        util    = ewen.transit.util,
        d       = ewen.transit.delimiters,
    ...
    decoder.Decoder = function Transit$Decoder(options) {
        ...
        /* NOT PUBLIC */
        this.mapBuilder = this.options["mapBuilder"] || ewen.transit.impl.decoder_builders.__GT_MapBuilder();
        this.arrayBuilder = this.options["arrayBuilder"] || ewen.transit.impl.decoder_builders.__GT_VectorBuilder();
    };
    ...
    decoder.Decoder.prototype.defaults = {
        handlers: {
            ...
            ":": function (v, d) {
                return cljs.core.keyword(v);
            },
            "$": function (v, d) {
                return cljs.core.symbol(v);
            },
            "r": function (v, d) {
                return types.uri(v);
            },
            ...
            "set": function (v, d) {
                return cljs.core.into(cljs.core.PersistentHashSet.EMPTY, v);
            },
            "list": function (v, d) {
                return cljs.core.into(cljs.core.List.EMPTY, v.reverse());
            },
            "link": function (v, d) {
                return types.link(v);
            },
            "cmap": function (v, d) {
                return ewen.transit.impl.cljs_handlers.cmap_handler(v);
            }
        },
